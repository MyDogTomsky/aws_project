...
# File(object) PATH // RDS location, name // RDS master id,pwd
...
# Preparation the environment(Update & Install Flyway)
sudo dnf update -y
...
# Create 'migration' Directory in EC2 for Copying Object from S3
